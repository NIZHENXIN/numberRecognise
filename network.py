...
# 读取训练数据文件中的数据，并保存到列表中C:\Users\nzx\Desktop
training_data_file = open("C://Users/nzx/Desktop/mnist_train_100.csv", 'r')
...
# 读取测试数据C:\Users\nzx\Desktop
test_data_file = open("C://Users/nzx/Desktop/mnist_test_10.csv", 'r')
